...
export const IMAGES = new Proxy({
	[AVATAR]: { imgSrc: '/avatar.jpg', altText: 'About Me' },
	[VCU]: { imgSrc: '/vcu.png', altText: 'VCU' },
	[SAGE]: { imgSrc: '/sage.png', altText: 'Sage' },
	[PIVOTAL]: { imgSrc: '/pivotal.png', altText: 'Pivotal' },
	[VMWARE]: { imgSrc: '/vmware.png', altText: 'VMware' },
	[FALLBACK]: { imgSrc: '', altText: '' },
}, withFallback);
...
export const COLORS = new Proxy({
	...
	[PIVOTAL]: { backgroundColor: 'rgb(178, 241, 232)', textColor: 'black', glowColor: 'rgb(22, 169, 144)' },
